...
export default function Example() {
    return (
        <div className=" bg-gradient-to-tl from-zinc-900/0 via-zinc-900 to-zinc-900/0 h-[100vh]">
            ...
            <div className="text-zinc-400 relative bg-[url(/site.png)] bg-center bg-contain bg-right-top bg-no-repeat shadow-xl mt-20">
                        ...
                        <Card>
                            <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right p-4 rounded-xl bg-gray-900/75 bg-transparent from-gray-900/75 to-white-25 bg-gradient-to-r bg-gradient-to-l">
                                ...
                                <p className="mt-4 max-w-lg sm:text-xl/relaxed text-left">
                                 Gostaria de aparecer para seus clientes com um site moderno e funcional para mostrar a sua marca mas não sabe como? Entre em contato conosco e se preocupe só em vender.
                                </p>
                                <Link
                                    href="/contact"
                                    style={{ margin: "0 auto" }}
            ...
            <MediaQuery query="(max-device-width: 768px)">
                <div className="relative bg-[url(/site.png)] bg-center bg-contain bg-no-repeat shadow-xl mt-20 w-100 h-[20em]"></div>
